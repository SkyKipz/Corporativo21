...
$query = "SELECT * FROM negocio_pertenece_categoria WHERE IdCategoria =  ${consulta};";
$rConsulta = mysqli_query($db, $query);

$queryC = "SELECT * FROM categoria WHERE IdCategoria = ${consulta};";
$rConsultaC = mysqli_query($db, $queryC);
$valorTitulo = mysqli_fetch_assoc($rConsultaC);
...
<div class="seccionFooter__header">
    <h3>Categoria: <?php echo $valorTitulo['Nombre']; ?></h3>
</div>
